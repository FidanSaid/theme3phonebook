...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { address: @phone.address, email: @phone.email, name: @phone.name, note: @phone.note, number: @phone.number } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { address: @phone.address, email: @phone.email, name: @phone.name, note: @phone.note, number: @phone.number } }
